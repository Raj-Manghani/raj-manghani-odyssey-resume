export const experiences = [
  {
    date: '04/2009 - Present',
    title: 'Founder & Principal IT Consultant',
    company: 'OrgNetworks (Organic Networks, LLC), San Diego/Poway, California United States',
    description: [
      '<strong>Technology Infrastructure Design & Management:</strong> Directed all aspects of IT strategy, infrastructure design, and service delivery for self-owned ventures and select external clients, consistently aligning technology with core business objectives.',
      '<strong>CICD Design and Management:</strong> Spearheaded the development and continuous integration/continuous deployment (CI/CD) pipelines using Jenkins and GitHub Actions, streamlining deployment processes and improving software release reliability by (e.g., reducing deployment times by 30%).',
      '<strong>Networking and Security:</strong> Responsible for designing and continuously managing Windows and Linux-based on-premises networks. Ensuring network security through firewalls, segmentation strategies, malware protection, and well-defined user policies and procedures. Integrated encryption protocols to safeguard data both at rest and in transit.',
      '<strong>Technical Support:</strong> Provided expert-level technical support and C-suite advisory, resolving complex hardware, software, and network challenges to ensure business continuity and operational stability across all operations.',
      '<strong>Technology Evaluation & Cost-Saving Strategies:</strong> Researched emerging technologies and evaluated their potential impact, comparing them to existing infrastructure to identify opportunities for cost savings and enhanced security. Implemented strategic upgrades to optimize performance while maintaining budget efficiency.',
    ],
  },
  {
    date: '06/2014 - 06/2024',
    title: 'SRE/System Administrator/Tech Support via OrgNetworks',
